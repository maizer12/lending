(() => {
  ...
  const b = {
    ...
    is: function (e) {
      ...
      if ("string" == typeof e) {
        ...
        for (n = v(e), a = 0; a < n.length; a += 1) if (n[a] === i) return !0;
        return !1;
      }
      if (e === s) return i === s;
      if (e === t) return i === t;
      ...
      if (
        ...
        if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -c;
          ...
          if (!a.support.smoothScroll)
            return (
              $({ swiper: a, targetPosition: -c, side: e ? "left" : "top" }), !0
            );
    ...
    slideTo: function (e, t, s, i, n) {
      ...
      if (o.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!a.support.smoothScroll)
            return (
              $({ swiper: a, targetPosition: s, side: e ? "left" : "top" }), !0
            );
  ...
  function ce(e) {
    ...
    function c() {
      ...
      if (
        ("fraction" === s.type &&
          (a.find(de(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
          a.find(de(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let e;
    ...
    function p() {
      ...
      if ("bullets" === e.type) {
        ...
        i.html(a), (t.pagination.bullets = i.find(de(e.bulletClass)));
      }
      "fraction" === e.type &&
        ((a = e.renderFraction
  ...
  setTimeout(() => {
    ...
    document.querySelector(".menu__icon").addEventListener("click", () => {
      document.querySelector(".icon-menu").classList.toggle("menu-open"),
        document.querySelector(".menu__body").classList.toggle("body-open"),
        document.querySelector(".menu__list").classList.toggle("list-open");
    }),
    (window.FLS = !0),
    (function (e) {
      let t = new Image();
